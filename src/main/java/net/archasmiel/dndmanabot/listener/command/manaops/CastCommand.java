package net.archasmiel.dndmanabot.listener.command.manaops;

import java.util.Objects;
import java.util.stream.IntStream;
import net.archasmiel.dndmanabot.database.ManaController;
import net.archasmiel.dndmanabot.database.basic.Pair;
...
import net.archasmiel.dndmanabot.util.mana.maps.SpellCost;
